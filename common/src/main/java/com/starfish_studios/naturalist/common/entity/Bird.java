...
public class Bird extends ShoulderRidingEntity implements FlyingAnimal, GeoEntity {
    ...
    protected static final RawAnimation SIT_ANIM = RawAnimation.begin().thenPlay("bird.sit");
    protected static final RawAnimation FLY_ANIM = RawAnimation.begin().thenPlay("bird.fly");
    private BirdAvoidEntityGoal<Player> avoidPlayersGoal = new BirdAvoidEntityGoal<>(this, Player.class, 16.0F, 2.0D, 2.0D);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(7, avoidPlayersGoal);
    ...
    private void calculateFlapping() {
        ...
        this.flapSpeed += (float)(!onGround() && !this.isPassenger() ? 4 : -1) * 0.3F;
